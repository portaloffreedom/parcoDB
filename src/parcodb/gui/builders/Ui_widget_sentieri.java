...
public class Ui_widget_sentieri implements com.trolltech.qt.QUiForm<QWidget>
{
    ...
    public void setupUi(QWidget widget_sentieri)
    {
        ...
        sizePolicy1.setHeightForWidth(listWidget_tappa.sizePolicy().hasHeightForWidth());
        listWidget_tappa.setSizePolicy(sizePolicy1);
        ...
        sizePolicy2.setHeightForWidth(listWidget_tappa2.sizePolicy().hasHeightForWidth());
        listWidget_tappa2.setSizePolicy(sizePolicy2);
        ...
        sizePolicy3.setHeightForWidth(listWidget_tappa3.sizePolicy().hasHeightForWidth());
        listWidget_tappa3.setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(listWidget_tappa4.sizePolicy().hasHeightForWidth());
        listWidget_tappa4.setSizePolicy(sizePolicy4);
        ...
        sizePolicy5.setHeightForWidth(listWidget_tappa5.sizePolicy().hasHeightForWidth());
        listWidget_tappa5.setSizePolicy(sizePolicy5);
        ...
        sizePolicy6.setHeightForWidth(listWidget_tappa6.sizePolicy().hasHeightForWidth());
        listWidget_tappa6.setSizePolicy(sizePolicy6);
        ...
        sizePolicy7.setHeightForWidth(listWidget_tappa7.sizePolicy().hasHeightForWidth());
        listWidget_tappa7.setSizePolicy(sizePolicy7);
        ...
        sizePolicy8.setHeightForWidth(listWidget_tappa8.sizePolicy().hasHeightForWidth());
        listWidget_tappa8.setSizePolicy(sizePolicy8);
        ...
        sizePolicy9.setHeightForWidth(listWidget_tappa9.sizePolicy().hasHeightForWidth());
        listWidget_tappa9.setSizePolicy(sizePolicy9);
        ...
        sizePolicy10.setHeightForWidth(listWidget_tappa10.sizePolicy().hasHeightForWidth());
        listWidget_tappa10.setSizePolicy(sizePolicy10);
